...
describe('API Integration Tests', () => {
    describe('GET /api/trading/status', () => {
        it('should return correct data structure matching frontend expectations', async () => {
    ...
    describe('GET /api/trading/positions', () => {
        it('should return correct PositionsData structure matching frontend expectations', async () => {
            const response = await request(app)
        ...
        it('should return positions array with correct structure', async () => {
            const response = await request(app)
                .get('/api/trading/positions')
                .expect(200);
