...
class PTLClient(EWrapper, EClient):
    ...
    def orderStatus(self, order_id, status, filled, remaining, avgFillPrice, permId, parentId, lastFillPrice, clientId,
                    whyHeld, mktCapPrice):
...
if __name__ == '__main__':
    ...
    chart.topbar.switcher('timeframe', ('5 mins', '15 mins', '1 hour', '1 day'), default='5 mins', func=on_timeframe_selection)
